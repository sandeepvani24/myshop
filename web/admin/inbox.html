        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="logo-area">
                        <a href="#"><img src="admin/img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
                                ...
                                <div role="menu" class="dropdown-menu message-dd animated zoomIn">
                                    ...
                                    <div class="hd-message-info">
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="admin/img/post/1.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                                    <h3>David Belle</h3>
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="admin/img/post/2.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                                        ...
                                        <a href="#">
                                            <div class="hd-message-sn">
                                                <div class="hd-message-img">
                                                    <img src="admin/img/post/4.jpg" alt="" />
                                                </div>
                                                <div class="hd-mg-ctn">
                            ...
                            <ul class="mobile-menu-nav">
                                ...
                                <li><a data-toggle="collapse" data-target="#demodepart" href="#">Tables</a>
                                    <ul id="demodepart" class="collapse dropdown-header-top">
                                        ...
                                        <li><a href="products.jsp.html">Data Table</a></li>
                                    </ul>
                                </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Tables" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="products.jsp.html">Data Table</a>
                                </li>
                            </ul>
                        </div>
